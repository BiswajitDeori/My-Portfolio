...
export const workDetails = [
  {
    ...
    Exprince:true,
    ExprinceDetails:["Extensively worked on .NET applications using C#, ASP.NET, and web services.","Designed user interfaces using HTML, JavaScript, and CSS to enhance the front-end experience","Created stored procedures and various database objects within Microsoft SQL Server.","Developed React pages and components while implementing Redux state management and custom packages."
  ,"Wrote comprehensive unit test cases to achieve and maintain 100% code coverage.","Established an automated pipeline for SQL query rollback, ensuring swift response to deployment issues.","Fixed Bug present in Production"]
  },
  {
    Position: "Internship",
    ...
    Exprince:true,
    ExprinceDetails:["Working on optical character recognition","Train a model using Own datasets","Use it in a real-time environment to detect mathematical expressions and handwritten Numbers."]
  },
