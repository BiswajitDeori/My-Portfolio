...
function Work({ position, company, location, type, duration ,exprince,details}) {
  return (
      ...
      <div className="flex justify-between pt-2">
        <div className="flex flex-col md:flex-row">
          <div className="flex items-center pr-5">
            ...
            <p className="text-content text-sm md:text-lg font-bold pl-1">{company}</p>
          </div>
          <div className="flex items-center">
            ...
            <p className="text-content text-xs md:text-sm font-light pl-1" style={{color:"blue"}}>{location}</p>
          </div>
        </div>
        ...
        { exprince? (
          <ul className="list-disc pl-6">
            {details.map((detail,key)=>(
              <li className="text-content md:text-lg lg:text-xl font-light" key={key}>{detail}</li>
            ))}
        </ul>
        ):""
      }
